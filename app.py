...
# Depression model using PySpark and Decision Tree
dt_model = PipelineModel.load('model/depression_model')
spark = SparkSession.builder.appName('final_project').getOrCreate()
# Create a vector assembler to transform the input data
assembler = VectorAssembler(inputCols=['sex', 'age', 'married', 'number_children', 'education_level',
                                       'total_members', 'gained_assets', 'durable_assets', 'save_asset',
                                       ...
                                       'farm_expenses', 'labour_primary', 'lasting_investment',
                                       'no_lasting_investmen'], outputCol='features')
